                ...
                <div className="flex items-center justify-center min-h-screen px-4 xl:px-0">
                    <div className="w-full flex flex-col items-center max-w-md bg-ivory/5 backdrop-blur-2xl rounded-2xl shadow-md py-5">
                        <div className="text-center mb-6">
                            <h1 className="font-edu text-3xl font-semibold text-ivory">Sign Up</h1>
                        </div>
                        <div className="flex flex-col w-2/3 mb-3">
                            {/* <label htmlFor="" className="font-poppins text-sm">Email</label> */}
                            <input name="email" type="email" className="border-b focus:outline-none px-4 py-2 font-poppins border-ivory text-ivory" placeholder="Email Address" />
                        </div>
                        <div className="flex flex-col w-2/3 mb-3">
                            {/* <label htmlFor="" className="font-poppins text-sm">Email</label> */}
                            <input name="email" type="email" className="border-b focus:outline-none px-4 py-2 font-poppins border-ivory text-ivory" placeholder="Phone Number" />
                        </div>
                        <div className="flex flex-col w-2/3 mb-3">
                            {/* <label htmlFor="" className="font-poppins text-sm">Email</label> */}
                        ...
                        <button className="border rounded-full mt-2 px-6 py-2 font-poppins border-primary bg-primary hover:bg-olivegreen hover:border-olivegreen shadow-md hover:shadow-2xl duration-300 text-ivory cursor-pointer w-2/3">Create Account</button>
                        <p className="font-poppins text-sm text-ivory mt-3">Already have an account? <Link href="/login" className="font-semibold text-ivory">Login</Link></p>
                    </div>
                </div>
            </div>
        </section>
